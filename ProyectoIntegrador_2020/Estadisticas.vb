Public Class Estadisticas
    ...
    Sub ActualizarGrafica()
        ...
        ds = consulta.consultarGrafica("SELECT count(Nombre) as Cliente, SUM(cc.saldo) as Saldo from compraCliente as cc,Clientes as c where cc.idCliente = c.idCliente AND MONTH(fechaCompra) BETWEEN " & mesAnterior & " AND (Select MONTH(NOW())) group by cc.idCliente limit 15;")

        chartGrafica.Size = New Size(600, 200)
        chartGrafica.Series.Clear()
        chartGrafica.Series.Add("Clientes")
        chartGrafica.Series("Clientes").XValueMember = "Cliente"
